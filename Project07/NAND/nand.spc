*SPICE circuit <nand> from XCircuit v3.10 rev 39
.GLOBAL vdd
...
.subckt nand in2 in1 out
M1 int4 in2 GND agnd nfet w=0.22u l=0.18u m=1
M2 out in1 int4 agnd nfet w=0.22u l=0.18u m=1
M3 out in1 Vdd avdd pfet W=0.44u L=0.18u M=1
M4 out in2 Vdd avdd pfet W=0.44u L=0.18u M=1
.ends
